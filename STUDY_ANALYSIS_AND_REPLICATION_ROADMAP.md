...
|--------|------|------------|--------|
| **scripts/python/download_data.py** | Bulk RNA-seq, ChIP-seq, CUT&RUN, sorted fibroblasts | **~150 GB** | Any machine (ARM64, x86) |
| **scripts/python/download_cellranger_data.py** | scRNA-seq, snRNA-seq, scATAC-seq (10x) | ~1–4 TB (--minimal; scATAC is huge) / multi-TB (full) | x86 only (Cell Ranger) |
...
python scripts/python/download_cellranger_data.py --minimal   # ~1–4 TB FASTQs for Figs 1-5 (5 scATAC)
